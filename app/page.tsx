...
export default function LandingPage() {
  return (
    <div className="bg-black text-white min-h-screen font-belleza selection:bg-red-600 overflow-x-hidden relative">
      ...
      <nav className="flex justify-between items-center px-6 md:px-20 py-5 md:py-8 border-b border-zinc-900 bg-black/50 backdrop-blur-xl sticky top-0 z-[100]">
        <div className="flex items-center gap-3">
           ...
           <div className="text-xl md:text-2xl font-alice uppercase tracking-tighter leading-none">
             BLAZE<span className="text-red-600">OPS</span>
           </div>
        </div>
        
        <div className="flex items-center gap-4 md:gap-8 font-belleza font-bold">
          <Link href="/login" className="text-[10px] md:text-xs uppercase tracking-widest hover:text-red-600 transition-colors hidden sm:block">
            Member Login
          </Link>
          <Link href="/register" className="text-[10px] md:text-xs bg-red-600 px-6 py-3 rounded-full uppercase tracking-widest hover:bg-white hover:text-black transition-all shadow-lg shadow-red-900/20 active:scale-95 italic">
            Join Squad
          </Link>
        </div>
      </nav>
      ...
      <section className="px-6 md:px-20 pt-20 md:pt-32 pb-16 text-left md:text-center relative max-w-7xl mx-auto">
        ...
        <h1 className="text-[52px] md:text-[130px] font-alice uppercase leading-[0.9] tracking-tighter mb-8 drop-shadow-2xl">
          Telkom<br className="md:hidden" />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-red-500 to-orange-500">Blaze</span>
        </h1>
        
        <p className="text-zinc-500 text-sm md:text-xl mb-12 leading-relaxed max-w-sm md:max-w-2xl md:mx-auto italic font-belleza">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 font-belleza font-bold">
          <Link href="/register" className="group w-full md:w-64 flex items-center justify-between md:justify-center md:gap-4 bg-white text-black p-5 md:py-6 rounded-2xl uppercase text-xs tracking-[0.2em] transition-all hover:bg-red-600 hover:text-white shadow-xl">
             Get Started
             <ArrowRight className="group-hover:translate-x-2 transition-transform" size={18}/>
          </Link>
          <Link href="/dashboard/gallery" className="w-full md:w-64 flex items-center justify-between md:justify-center md:gap-4 bg-zinc-900/50 border border-zinc-800 p-5 md:py-6 rounded-2xl uppercase text-xs tracking-[0.2em] text-zinc-400 hover:border-red-600 hover:text-white transition-all group">
             Watch Intel
      ...
      {/* --- MISSION GALLERY --- */}
      <section className="py-24 px-6 md:px-20 max-w-7xl mx-auto border-t border-zinc-900 font-belleza">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
          <div className="space-y-4 text-left">
            <div className="flex items-center gap-2">
              <div className="w-8 h-[2px] bg-red-600"></div>
              <span className="text-[9px] md:text-[10px] font-bold text-red-600 uppercase tracking-[0.4em] leading-none">Visual Records</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-alice uppercase tracking-tighter leading-none">
        ...
        <div className="flex md:grid md:grid-cols-4 gap-4 overflow-x-auto pb-8 md:pb-0 scrollbar-hide snap-x">
          <div className="min-w-[300px] md:min-w-0 md:col-span-2 md:row-span-2 relative group overflow-hidden rounded-[2.5rem] border border-zinc-900 snap-center">
            ...
            <div className="absolute bottom-8 left-8">
              <p className="text-red-600 text-[10px] font-bold uppercase tracking-widest mb-2 italic font-belleza">Operation // Victory</p>
              <h3 className="text-2xl font-alice uppercase leading-none">Champion Celebration</h3>
            </div>
          </div>
          ...
          <div className="min-w-[280px] md:min-w-0 relative group overflow-hidden rounded-[2.5rem] border border-zinc-900 snap-center">
            ...
            <div className="absolute bottom-6 left-6 text-[10px] font-bold uppercase tracking-widest italic font-belleza">Training Drill</div>
          </div>
          ...
          <div className="min-w-[280px] md:min-w-0 relative group overflow-hidden rounded-[2.5rem] border border-zinc-900 snap-center">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent"></div>
            <div className="absolute bottom-6 left-6 text-[10px] font-bold uppercase tracking-widest italic font-belleza">Tactical Meeting</div>
          </div>
          ...
          <div className="min-w-[280px] md:min-w-0 md:col-span-2 relative group overflow-hidden rounded-[2.5rem] border border-zinc-900 snap-center h-[250px] md:h-auto shadow-2xl">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="px-8 py-3 border border-white/10 rounded-full backdrop-blur-md group-hover:border-red-600 transition-all">
                <span className="text-[10px] font-bold uppercase tracking-[0.4em] italic font-belleza">Showcase Pride</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* --- FOOTER --- */}
      <footer className="pt-24 pb-12 px-6 md:px-20 max-w-7xl mx-auto border-t border-zinc-900 font-belleza">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
          <div className="space-y-6">
            <div className="text-3xl font-alice uppercase tracking-tighter">
          ...
          <div className="text-left md:text-right space-y-2">
            <p className="text-[8px] md:text-[10px] font-bold uppercase tracking-[0.4em] text-zinc-700 italic leading-loose">
              Developed by Futsal TUKJ // Version 2.0.26 <br />
...
function StatCard({ icon, value, label }: { icon: any, value: string, label: string }) {
  return (
    <div className="min-w-[200px] flex-1 bg-zinc-900/40 border border-zinc-800/60 p-8 md:p-12 rounded-[2.5rem] backdrop-blur-md snap-center hover:border-red-600/40 transition-all group">
      ...
      <h3 className="text-3xl md:text-5xl font-alice uppercase leading-none mb-2 tracking-tighter">{value}</h3>
      <p className="text-[9px] md:text-[10px] font-bold text-zinc-600 uppercase tracking-widest italic font-belleza">{label}</p>
    </div>
  );
}